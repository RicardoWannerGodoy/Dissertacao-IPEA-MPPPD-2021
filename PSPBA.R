...
######################################################################################
# A SIMULAÇÃO DE CENÁRIOS EVIENCIANDO A EFICIÊNCIA DAS POLÍTICAS DE SEGURANÇA PÚBLICA# 
#      NO COMBATE A CRIMINALIDADE E A VIOLÊNCIA NA CIDADE DE SALVADOR NA BAHIA.      #
######################################################################################
...
# dea(X, Y, RTS="vrs", ORIENTATION="in", XREF=NULL, YREF=NULL, FRONT.IDX=NULL, SLACK=FALSE, DUAL=FALSE, 

# DIRECT=NULL, param=NULL, TRANSPOSE=FALSE, FAST=FALSE, LP=FALSE, CONTROL=NULL, LPK=NULL)
######################################################################################################
...
# [01] vrs: Retornos variáveis a escala, convexidade e free disposability;

# [02] drs: Retornos decrescentes a escala, convexidade, down-scaling e "free disposability" 
# (disponibilidade fraca);

# [03] crs: Retornos constantes a escala, convexidade e free disposability;

# [04] irs: Retornos crescentes a escala, (up-scaling, mas não down-scaling), convexidade e free disposability;

# [05] irs2: Retornos crescentes a escala (up-scaling, mas não down-scaling), additividade e free disposability;

# [06] add: Aditividade (scaling up e down, mas apenas com inteiros), e free disposability; 

# [07] fdh+: Combinação de "free disposability" e restrito ou retornos constantes a escala local;

# [10] vrs+: Retornos variáveis a escala, mas não há restrições sobre os lambdas individuais via parametro;
...
# [14] SLACK: Calcula as folgas dos insumos/produtos na etapa 2ª via função slack; e
...
# Combinando os resultados em uma unica tabela.
...
# a mesma quantidade produzida as diferentes condições de capital e trabalho.
######################################################################################################
...
# Retornos crescentes da escala orientada aos Insumo.
...
# Retornos decrescentes da escala orientada aos Insumos.
...
# Podemos combinar todas as medidas de eficiência em apenas um tabela dos Insumos.
...
# Retornos decrescentes da escala orientada aos Produtos.
